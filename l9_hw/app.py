...
from l9_hw.schemas import *
from l9_hw.db_queries import *
from l9_hw.helpers import translate_to
...
def song(id_artist, id_song):
    if request.method == 'GET':
        ...
        translate = request.form.to_dict().get('translate')
        data_artist = get__artist__by_id(id_artist)
        data_album = get__album__by_id(id_album)
        ...
        try:
            validate_song_data__update({'song_text': new_text})
        except Exception as e:
            return e
